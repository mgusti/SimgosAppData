            ...
            <div className="content">
                                ...
                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-900 mt-4 border border-gray-500">
                                    <thead className="text-sm font-bold text-gray-900 bg-gray-300 dark:text-gray-900 border border-gray-500">
                                        <tr>
                                            ...
                                            <th className="px-3 py-2 border border-gray-500 border-solid">NAMA TINDAKAN</th>
                                            <th className="px-3 py-2 border border-gray-500 border-solid text-center w-[7%]">RAWAT JALAN</th>
                                            <th className="px-3 py-2 border border-gray-500 border-solid text-center w-[7%]">RAWAT DARURAT</th>
                                            <th className="px-3 py-2 border border-gray-500 border-solid text-center w-[7%]">RAWAT INAP</th>
                                    ...
                                    <tbody>
                                        {data.map((item, key) => {
                                            return (
                                                <tr key={item.NAMATINDAKAN} className="border-b bg-white dark:border-gray-500">
                                                    ...
                                                    <td className="px-3 py-2 text-center border border-gray-500 border-solid">
                                                        {formatRibuan(item.RJ) || 0}
                                                    </td>
                                                    <td className="px-3 py-2 text-center border border-gray-500 border-solid">
                                                        {formatRibuan(item.RD) || 0}
                                                    </td>
                                                    <td className="px-3 py-2 text-center border border-gray-500 border-solid">
                                                        {formatRibuan(item.RI) || 0}
                                                    </td>
                                                    <td className="px-3 py-2 text-center border border-gray-500 border-solid">
                                    ...
                                    <tfoot>
                                        <tr className='bg-gray-300 font-bold text-sm'>
                                            ...
                                            <td className="px-2 py-2 text-center border border-gray-500 border-solid">{formatRibuan(total.RJ) || 0}</td>
                                            <td className="px-2 py-2 text-center border border-gray-500 border-solid">{formatRibuan(total.RD) || 0}</td>
                                            <td className="px-2 py-2 text-center border border-gray-500 border-solid">{formatRibuan(total.RI) || 0}</td>
                ...
                <footer className="bg-white text-black text-sm">
                    <div className="text-center">
                        <p>&copy; 2024 - {new Date().getFullYear()} Gusti - Tim IT RSUD H. Abdul Manap.</p>
                    </div>
                </footer>
            </div>
        </div>

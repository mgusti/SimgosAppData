...
export default function PengunjungPerPasien({
    ...
    const headers = [
        ...
        { name: "TANGGAL REGISTRASI", className: "text-center w-[10%]" },
                                            ...
                                            <th colSpan={8} className="px-3 py-2">
                                                <div className="flex items-center space-x-2">
                                                    <TextInput
                                                        ...
                                                        placeholder="Cari data berdasarkan nomor pendaftaran, NORM, nama pasien, status, cara bayar, unit layanan atau dokter"

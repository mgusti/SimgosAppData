                                ...
                                <table className="w-full text-[10px] text-left rtl:text-right text-gray-500 dark:text-gray-900 mt-4 border border-gray-500">
                                    <thead className="text-[10px] font-bold text-gray-900 bg-gray-300 dark:text-gray-900 border border-gray-500">
                                        <tr>
                                            ...
                                            <th className="px-3 py-2 border border-gray-500 border-solid text-right w-[9%]">TARIF RS</th>
                                            <th className="px-3 py-2 border border-gray-500 border-solid w-[9%]">STATUS GROUPING</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {data.map((item, key) => {
                                            return (
                                                <tr key={item.NORM} className="border-b bg-white dark:border-gray-500">
                                                    ...
                                                    <td className="px-3 py-2 text-nowrap text-right border border-gray-500 border-solid">
                                                        {formatRibuan(item.TARIFRS)}
                                                    </td>
                                                    <td className="px-3 py-2 text-wrap border border-gray-500 border-solid">
                                                        {item.CARABAYAR?.toLowerCase().includes("bpjs") ? item.STATUS_GROUPING : ' '}
                                                    </td>
                                                </tr>
                                            );
                                        })}
